            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="card card-details card-right">
                        ...
                        <table class="trip-informations">
                            ...
                            <tr>
                                ...
                                <td width="50%" class="text-right text-total">
                                    ...
                                    {{--  //mt_rand untuk random string jadi kalo pembayaran ada kode unik  --}}
                                </td>
                            </tr>
                        </table>
                        ...
                        <div class="bank">
                            ...
                            <div class="bank-item">
                                ...
                                <div class="clearfix"></div>
                                <!-- karna kita kasih float jadi kita kasih clear fix -->
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="text-center mt-3">
                        <a href="{{ route('detail', $item->travel_package->slug) }}" class="text-muted"> Cancel Booking
                        </a>
                    </div>
                </div>
            </div>
