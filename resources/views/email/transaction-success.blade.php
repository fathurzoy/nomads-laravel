                            ...
                            <div class="mj-column-per-100 mj-outlook-group-fix"
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                    <tbody>
                                        <tr>
                                            <td
                                                style="border-bottom:1px dashed #eeeeee;vertical-align:middle;padding-bottom:30px;">
                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                                    style="" width="100%">
                                                    <tbody>
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <br /> Booking ID <strong>#{{ $data->id }}</strong>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                    ...
                                                    <tr>
                                                        <td style="width: 50px">
                                                            <img src="{{ url('frontend/images/ic_support@2x.png') }}"
                                                                width="50px" </td> <td
                                                                style="font-size: 18px; padding-left: 10px; color: #0f1c4d; font-family= Assistant, Helvetica, Arial, sans-serif">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="center"
                                                ...
                                                <div
                                                    style="font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;line-height:1;text-align:center;color:#888893;">
                                                    2019 Nomads Copyright All Nights Reserved.</div>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
